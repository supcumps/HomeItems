#tag MobileScreen
Begin MobileScreen ScreenMaintenance
   BackButtonCaption=   ""
   Compatibility   =   ""
   ControlCount    =   0
   Device = 7
   ...
   Begin iOSMobileTable TableMaintenance
      ...
      AllowRefresh    =   False
      AllowSearch     =   False
      AutoLayout      =   TableMaintenance, 4, <Parent>, 4, False, +1.00, 4, 1, -*kStdGapCtlToViewV, , True
      AutoLayout      =   TableMaintenance, 1, <Parent>, 1, False, +1.00, 4, 1, *kStdGapCtlToViewH, , True
      AutoLayout      =   TableMaintenance, 3, TopLayoutGuide, 3, False, +1.00, 4, 1, *kStdControlGapV, , True
      AutoLayout      =   TableMaintenance, 7, , 0, False, +1.00, 4, 1, 320, , True
      ControlCount    =   0
...
#tag WindowCode
	...
	#tag Event
		Sub ToolbarButtonPressed(button As MobileToolbarButton)
		  ...
		  Select Case Button
		  Case AddButton
		    Var AddMaintenanceScreen  As New ScreenAddMaintenanceItem
		    AddMaintenanceScreen.Show
		  End Select
	...
	#tag Property, Flags = &h21
		Private DataSource As MaintenanceTableDataSource
	#tag EndProperty


#tag EndWindowCode

#tag Events TableMaintenance
	#tag Event
