#tag MobileScreen
Begin MobileScreen ScreenRepairs
   BackButtonCaption=   ""
   Compatibility   =   ""
   ControlCount    =   0
   Device = 7
   ...
   Begin iOSMobileTable TableRepairs
      ...
      AllowRefresh    =   False
      AllowSearch     =   False
      AutoLayout      =   TableRepairs, 4, <Parent>, 4, False, +1.00, 4, 1, -*kStdGapCtlToViewV, , True
      AutoLayout      =   TableRepairs, 1, <Parent>, 1, False, +1.00, 4, 1, *kStdGapCtlToViewH, , True
      AutoLayout      =   TableRepairs, 3, TopLayoutGuide, 3, False, +1.00, 4, 1, *kStdControlGapV, , True
      AutoLayout      =   TableRepairs, 7, , 0, False, +1.00, 4, 1, 320, , True
      ControlCount    =   0
...
#tag WindowCode
	...
	#tag Event
		Sub ToolbarButtonPressed(button As MobileToolbarButton)
		  ...
		  Select Case Button
		  Case AddButton
		    Var AddRepairScreen  As New ScreenAddRepairs
		    AddRepairScreen.Show
		  End Select
	...
	#tag Property, Flags = &h21
		Private DataSource As RepairsTableDataSource
	#tag EndProperty


#tag EndWindowCode

#tag Events TableRepairs
	#tag Event
