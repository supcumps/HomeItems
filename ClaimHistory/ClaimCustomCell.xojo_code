...
Begin MobileTableCustomCell ClaimCustomCell
   AccessibilityHint=   ""
   AccessibilityLabel=   ""
   ...
   Begin MobileLabel AmountLabel
      ...
      AccessibilityLabel=   ""
      Alignment       =   1
      AutoLayout      =   AmountLabel, 1, DateLabel, 2, False, +1.00, 4, 1, *kStdControlGapH, , True
      AutoLayout      =   AmountLabel, 2, <Parent>, 2, False, +1.00, 4, 1, -*kStdGapCtlToViewH, , True
      AutoLayout      =   AmountLabel, 8, , 0, False, +1.00, 4, 1, 30, , True
      AutoLayout      =   AmountLabel, 10, IDLabel, 10, False, +1.00, 4, 1, 0, , True
      ControlCount    =   0
      Enabled         =   True
      Height          =   30
      Left            =   147
