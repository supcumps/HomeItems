...
Begin MobileScreen ScreenEditItem
   ...
   Begin MobileTextField txtCategory
      ...
      AutoLayout      =   txtCategory, 7, , 0, False, +1.00, 4, 1, 202, , True
      BorderStyle     =   3
      ControlCount    =   0
      Enabled         =   True
      Height          =   34
   ...
   Begin MobileTextField txtLocation
      ...
      AutoLayout      =   txtLocation, 7, , 0, False, +1.00, 4, 1, 202, , True
      BorderStyle     =   3
      ControlCount    =   0
      Enabled         =   True
      Height          =   34
   ...
   Begin MobileTextField txtManufacturer
      ...
      AutoLayout      =   txtManufacturer, 7, , 0, False, +1.00, 4, 1, 202, , True
      BorderStyle     =   3
      ControlCount    =   0
      Enabled         =   True
      Height          =   34
   ...
   Begin MobileTextField txtModel
      ...
      AutoLayout      =   txtModel, 7, , 0, False, +1.00, 4, 1, 202, , True
      BorderStyle     =   3
      ControlCount    =   0
      Enabled         =   True
      Height          =   34
